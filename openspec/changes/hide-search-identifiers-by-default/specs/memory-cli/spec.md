...
- **TRACE**: `{"root":"repo:openspec","capability":"memory-cli","requirement":"Commands use a common result envelope","feature":"features/memory-cli/memory-cli.feature","scenario":"Empty successful query"}`
...
- **TRACE**: `{"root":"repo:openspec","capability":"memory-cli","requirement":"Commands use a common result envelope","feature":"features/memory-cli/memory-cli.feature","scenario":"Attention truncation precedes result limiting"}`
...
- **TRACE**: `{"root":"repo:openspec","capability":"memory-cli","requirement":"Commands use a common result envelope","feature":"features/memory-cli/memory-cli.feature","scenario":"Snapshot commands hide selected-trail identity unless requested"}`
